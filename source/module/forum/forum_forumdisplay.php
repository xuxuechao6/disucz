...
if($_G['forum']['redirect']) {
	...
	dheader("Location: forum-$_G[fid].html");
...
if($_G['forum']['type'] == 'forum') {
	...
	if(empty($_GET['archiveid'])) {
		$navigation = ' <em>&rsaquo;</em> <a href="forum-'.$forum_up['fid'].'.html">'.$forum_up['name'].'</a><em>&rsaquo;</em> <a href="forum.php?mod=forumdisplay&fid='.$_G['forum']['fid'].'">'.$_G['forum']['name'].'</a>';
	} else {
	...
	if(empty($_GET['archiveid'])) {
		...
		$navigation = ' <em>&rsaquo;</em> <a href="forum-'.$forum_top['fid'].'.html">'.$forum_top['name'].'</a><em>&rsaquo;</em> <a href="forum.php?mod=forumdisplay&fid='.$forum_up['fid'].'">'.$forum_up['name'].'</a><em>&rsaquo;</em> '.$_G['forum']['name'];
	} else {
