...
<p class="xs0">&copy; 2013-2017 <a href="https://www.rt-thread.org" target="_blank">上海睿赛德电子科技有限公司 </a> <a href="https://www.rt-thread.org" target="_blank">沪ICP备13014002号-1 </a></p>
<p>Powered by <strong><a href="https://www.rt-thread.org" target="_blank">RT-Thread</a></strong> <?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a><?php } ?></p><?php updatesession();?><?php if($_G['uid'] && $_G['group']['allowinvisible']) { ?>
<script type="text/javascript">
