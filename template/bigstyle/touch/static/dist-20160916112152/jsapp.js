...
define("ajax", ["require"], function (e) {
    var i = {},
        t = {},
        a = "";
    return t.getAjaxUrl = function (e) {
        ...
        jQuery.ajax({
            ...
            complete: function (e) {},
            success: function (e) {
                e.Variables && e.Variables.formhash && (a = e.Variables.formhash), n(e)
            },
            error: function (e, i, t) {
                var a = "Error(" + e.readyState + ") : " + i;
                console.log(a), MWT.alert("啊哦~~页面发生了错误，刷新下看看~~")
            }
        })
        console.log(i,"111111111111111111")
        ...
        i[e] ? t(i[e]) : this.post(e, {}, function (a) {
            i[e] = a, t(a)
        }, a)
...
}), define("conf", ["require", "ajax"], function (e) {
    var i, t = e("ajax"),
        a = {
            loglevel: 3,
            version: "1.9.0",
    ...
    return n.get = function () {
        return bigstyle_api ? (i || t.post2("config", {}, function (e) {
...
}), define("common/location", ["require"], function (e) {
    var i = {};
...
}), define("data/forum", ["require", "ajax"], function (e) {
    function i() {
        l.loadcache("version=4&module=forumindex", function (e) {
            n = {};
            for (var i = 0; i < e.Variables.forumlist.length; ++i) {
                ...
                if (n[a.fid] = {
                    ...
                    for (var o = 0; o < a.sublist.length; ++o) {
                        var r = a.sublist[o];
                        n[a.fid].sublist.push(r.fid), n[r.fid] = {
                            fid: r.fid,
                            name: r.name,
                            threads: r.threads,
                            posts: r.posts,
    ...
    function t(e) {
        if (o = '<option value="0">请选择版块</option>', e && e.Variables.catlist)
            for (var i = 0; i < e.Variables.catlist.length; ++i) {
                ...
                if (t.forums && t.forums.length) {
                    ...
                    for (var a = 0; a < t.forums.length; ++a) {
                        var r = t.forums[a],
                            l = n[r];
                        if (l && (o += '<option value="' + l.fid + '">' + l.name + "</option>", l.sublist && l.sublist.length > 0))
                            for (var d = 0; d < l.sublist.length; ++d) {
                                var s = l.sublist[d],
                                    c = n[s];
    ...
    function a() {
        l.loadcache("version=4&module=forumnav", function (e) {
            if (r = {}, e.Variables.forums)
                for (var i = 0; i < e.Variables.forums.length; ++i) {
                    var t = e.Variables.forums[i];
                    if (r[t.fid] = [], t.threadtypes && t.threadtypes.types)
                        for (var a in t.threadtypes.types) {
                            var n = {
                                tid: a,
    ...
    return d.getForumInfo = function (e) {
        ...
        if (0 == t.source && t.forums && t.forums.length > 0) i = t.forums;
            ...
            l.loadcache(a, function (e) {
                if (e.Variables.data && e.Variables.data.length)
                    for (var t = 0; t < e.Variables.data.length; ++t) {
                        var a = e.Variables.data[t];
                        i.push(a.fid)
                    }
                    console.log(e.Variables.data,333333333333)
            }, !0)
        }
        ...
        if (0 == e.length)
            for (var r in n)
                if (e.push(n[r]), e.length > 2) break;
        return e
...
}), define("data/thread", ["require", "data/forum", "ajax"], function (e) {
    var i = e("data/forum"),
        t = e("ajax"),
        a = {};
    return a.getNewThreads = function () {
        ...
        return MWT.show_loading(), t.post(o, {}, function (e) {
            MWT.hide_loading(), n = a.getParseThreadRes(e)
        }, !0), n
        ...
        for (var t = e.Variables.forum_threadlist.length, a = 0; t > a; ++a) {
...
}), define("index/index_tab", ["require", "data/thread", "common/location"], function (e) {
    var i = e("data/thread"),
        t = function (t, a) {
            function n(e) {
                a && a(o, e)
            ...
            this.init = function () {
                ...
                jQuery("#" + f).html(v), jQuery("[name=topthread]").unbind("click").click(function () {
    ...
    return t
}), define("common/copyright", ["require"], function (e) {
    var i = {};
...
}), define("member/login", ["require", "ajax"], function (e) {
    var i = e("ajax"),
        t = {};
    return t.login = function () {
        ...
        var e = i.getFormHash();
        e && "" != e || i.post("version=4&module=profile", {}, function (i) {
...
}), define("common/sidebar", ["require", "member/login"], function (e) {
    function i() {
        a = new MWT.SideBar({
            render: "uc-sidebar",
            width: "200px;",
    ...
    function t() {
        ...
        a += "</div>", jQuery("#uc-sidebar-div").html(a), jQuery("#uc-sidebar-btn").click(function () {
...
}), define("common/header", ["require", "common/sidebar"], function (e) {
    var i = {};
    return i.createHeader = function (i) {
        i.position = "top", i.cls = "headbar", i.height || (i.height = 40);
        ...
        return i.items = t, new MWT.H5Navbar(i)
    }, i.getHeaderIconStyle = function () {
        return "font-size:20px;margin-top:5px;"
    }, i
}), define("ad/adengine", ["require"], function (e) {
    var i = {};
...
}), define("ad/global_full_ad", ["require", "ajax", "./adengine"], function (e) {
    function i() {
        a.getad(1, function (e) {
            var i = dz.bodyHeight - 135,
                a = '<a href="' + e.adurl + '" class="ad"><img src="' + e.adimg + '" style="width:100%;height:' + i + 'px;"></a>';
            jQuery("#global_full_ad_div").html(a), t.open()
        })
    }
    ...
    return n.init = function () {
        ...
        }), t.create(), setTimeout(i, 5e3)
    }, n
}), define("ad/horizontal_ad", ["require", "ajax", "./adengine"], function (e) {
    function i() {
        a.getad(2, function (e) {
...
}), define("common/backtop", ["require"], function (e) {
    var i = {};
...
}), define("index/page", ["require", "common/location", "./index_tab", "ajax", "common/copyright", "common/header", "data/forum", "ad/global_full_ad", "ad/horizontal_ad", "data/forum", "common/backtop"], function (e) {
    ...
    function n(e, i) {
        ...
        MWT.show_loading(), s.post(t, {}, function (t) {
            MWT.hide_loading();
    ...
    return c.open = function (t) {
        i(), e("common/backtop").init(50)
    }, c
}), define("index/page2", ["require", "common/location", "./index_tab", "ajax", "common/copyright", "common/header", "data/forum", "data/forum", "common/backtop", "ad/global_full_ad", "ad/horizontal_ad"], function (e) {
    function i() {
        var i = '<div style="margin:40px 0 45px;background-color:#f2f2f2;"><div id="herad-div"></div><div id="indexbodydiv" style="margin-top:10px;"></div>' + e("common/copyright").footer() + '</div><div id="headdiv" style="position:fixed;top:0;left:0;right:0;"></div>';
        ...
        o.create(), t(), n = e("data/forum").getAllForumIds(), a();
    ...
    return r.open = function (t) {
        i(), e("common/backtop").init(50), e("ad/global_full_ad").init(), e("ad/horizontal_ad").init("herad-div")
    }, r
}), define("forum/forumlist", ["require", "ajax", "common/copyright", "common/header", "ad/horizontal_ad", "common/location", "common/backtop"], function (e) {
    function i() {
        ...
        a.create(), t(), e("ad/horizontal_ad").init("ad-div")
    }

    function t() {
        n.post("version=4&module=forumindex", {}, function (e) {
        ...
        for (var r = "", n = 0; n < i.length; ++n) {
            ...
            for (var s = 0; s < i[n].forums.length; ++s) {
                var c = i[n].forums[s],
                    ...
                    if(p.todayposts>0){
                        r += '<div name="fmdiv" data-fid="' + c + '" data-fname="' + p.name + '" class="weui_cell"><div class="weui_cell_hd"><img src="' + m + '" style="width:40px;height:40px;margin-right:10px;display:block"></div><div class="weui_cell_bd weui_cell_primary">' + p.name + '<br><span style="font-size:13px;">主题:' + p.threads + " | 帖子:" + p.posts + '</span></div><div class="weui_cell_ft"><span style="color:#ff0000;font-size:14px;padding:5px 10px;">( ' + p.todayposts + " )</span></div></div>"
           
                    }else{
                        r += '<div name="fmdiv" data-fid="' + c + '" data-fname="' + p.name + '" class="weui_cell"><div class="weui_cell_hd"><img src="' + m + '" style="width:40px;height:40px;margin-right:10px;display:block"></div><div class="weui_cell_bd weui_cell_primary">' + p.name + '<br><span style="font-size:13px;">主题:' + p.threads + " | 帖子:" + p.posts + '</span></div></div>'
           
                    }
                 }
            r += "</div></div>"
        }
        jQuery("#forumlistdiv").html(r), jQuery("[name=fmdiv]").click(function () {
...
}), define("forum/thread_tab", ["require", "common/location"], function (e) {
    var i = function (i, t) {
        function a(e) {
            t && t(n, e)
        }
        ...
        this.init = function () {
            ...
            jQuery("#" + m).html(f), jQuery("#" + p + "-nbtn").unbind("click").click(function () {
    ...
    return i
}), define("forum/forumdisplay", ["require", "common/location", "common/header", "ajax", "./thread_tab", "common/copyright", "common/header", "ad/horizontal_ad", "common/backtop"], function (e) {
    function i() {
        ...
        a.create(), u = !0, o = new c("formtabdiv-" + n, t), o.init(), e("ad/horizontal_ad").init("ad-div")
    }
    ...
    function t(e, i) {
        ...
        MWT.show_loading(), s.post(t, {}, function (e) {
            MWT.hide_loading(), u && (u = !1, a(e)), o.show_list(e)
        })
    }
    ...
    function a(e) {
        ...
        jQuery("#forumlist-topdiv-" + n).html(a), e.Variables.sublist.length > 0 && jQuery("[name=subforum]").click(function () {
            var e = jQuery(this).data("fid");
            r.forumdisplay(e)
    ...
    return p.open = function (t, a) {
        n = a, i(), e("common/backtop").init(10)
    }, p
}), define("common/seccode", ["require"], function (e) {
    var i = {};
    return i.create = function (e, i) {
        var t = i ? i : "",
            a = dz.securl + "&update=" + time(),
            n = '<img id="sec-' + e + '" src="' + a + '" style="cursor:pointer;' + t + '">';
        jQuery("#" + e).html(n), jQuery("#sec-" + e).click(function () {
            var e = dz.securl + "&update=" + time();
            jQuery(this).attr("src", e)
        })
    }, i
}), define("common/smiley", ["require"], function (e) {
    function i(e) {
        for (var i = o[e], e = i.substr(1), t = smilies_type["_" + e], n = smileyroot + "/" + t[1], r = smilies_array[e][1], l = 9, d = 100 / l + "%", s = '<table style="windth:100%"><tr>', c = 0; c < r.length; ++c) {
            ...
            c > 0 && c % l == 0 && (s += "</tr><tr>"), s += '<td width="' + d + '" align="center">' + p + "</td>"
        }
        for (; c % l;) s += '<td width="' + d + '"></td>', ++c;
        s += "</tr></table>", jQuery("#smiley-panel-div").html(s), jQuery("[name=smileybtn]").unbind("click").click(function () {
    ...
    return r.open = function (e) {
        0 == bigstyle_conf.plugin_type, a = mwt.$(e), n || (n = new MWT.SideBar({
            render: "siderbottom",
            position: "bottom",
            height: "240px",
...
}), define("forum/newthread", ["require", "common/header", "ajax", "data/forum", "common/copyright", "common/header", "common/seccode", "common/smiley", "member/login", "common/location"], function (e) {
    function i() {
        l = new MWT.Form, l.addField("subject", new MWT.TextField({
            render: "titlediv",
            value: "",
            placeholder: "标题",
            errmsg: "标题不能超过35个字符",
        ...
        o.create(), l.create(), e("common/seccode").create("secimg", "width:150px;"), l.reset(), a(), jQuery("#attaul").html(), jQuery("#picup-newth").change(t), jQuery("#picbtn").click(function () {
    ...
    function t() {
        mwt.show_loading("上传图片..."), jQuery.ajaxFileUpload({
            ...
            timeout: 3e4,
            complete: function (e) {
                mwt.hide_loading(), jQuery("#picup-newth").change(t)
            },
            success: function (e, i) {
                ...
                jQuery("#attaul").append(r), jQuery('[name="upimg-del"]').unbind("click").click(function () {
                    var e = jQuery(this).data("idx");
                    jQuery("#upimg-" + e).html(""), delete u[e]
                })
            },
            error: function (e, i, t) {
                mwt.alert(t)
    ...
    function a() {
        ...
        jQuery("#forumsel").html(e), 0 != r && set_select_value("forumsel", r), n(), jQuery("#forumsel").unbind("change").change(n)
    }
    ...
    function n() {
        ...
        if (i && i.length) {
            for (var t = '<option value="0">请选择主题分类</option>', a = 0; a < i.length; ++a) {
                var n = i[a];
                t += '<option value="' + n.tid + '">' + n.name + "</option>"
            }
            jQuery("#typesel").html(t), jQuery("#typeseldiv").show()
        } else jQuery("#typesel").html('<option value="0">请选择主题分类</option>'), jQuery("#typeseldiv").hide()
    }
    ...
    return p.open = function (t, a, n) {
        ...
        i.formhash = s.getFormHash(), i.posttime = time(), i.topicsubmit = "yes";
        var t = "version=4&module=newthread&extra=&inajax=1";
        s.post(t, i, function (t) {
...
}), define("forum/sendreply", ["require", "common/header", "ajax", "common/copyright", "common/seccode", "common/smiley"], function (e) {
    function i() {
        n = new MWT.Form, n.addField("message", new MWT.TextField({
            type: "textarea",
            render: "contentdiv",
        ...
        "0" != dz.postseccheck && (i = "flex", n.addField("seccodeverify", new MWT.TextField({
            ...
            n.create(), e("common/seccode").create("secimg", "width:150px;"), n.reset(), jQuery("#smilebtn").unbind("click").click(function () {
                e("common/smiley").open("contentdivtxt")
            })
        })
    }
    ...
    return s.open = function (e, n, l, d) {
        a = n ? n : 0, o = l, 0 != a && (t || i(), r = d ? d : null, t.setAnimate(e).open())
    }, s.submit = function () {
        var e = n.getData();
        e.message = get_text_value("contentdivtxt"), e.formhash = o;
        var i = "version=4&module=sendreply&replysubmit=yes&extra=&inajax=1&tid=" + a;
        d.post(i, e, function (e) {
...
}), define("forum/viewthread", ["require", "common/header", "ajax", "common/copyright", "./sendreply", "ad/horizontal_ad", "common/backtop"], function (e) {
    function i(e) {
        ...
        c.post3(i, t, function (i) {
            var t = jQuery("root", i).text();
            MWT.alert(t, function () {
    ...
    function t() {
        ...
        var n = new MWT.H5Navbar({
            ...
            items: [{
                ...
                label: "回复",
                handler: function () {
                    e("./sendreply").open("slideRight", l, d, function () {
                        a(1)
                    })
                }
            }, {
                ...
                handler: function () {
                    ...
                    c.post(e, {}, function (e) {
                        !e.Message || "favorite_do_success" != e.Message.messageval && "favorite_repeat" != e.Message.messageval ? MWT.alert({
                            msg: e.Message.messagestr
                        }) : MWT.toast({
                            msg: "已收藏"
                        })
    ...
    function n(e) {
        ...
        var f = "";
        1 == dz.groupid && (f = '<br><a href="javascript:;" name="threaddel" data-fid="' + e.Variables.fid + '">删除</a>'), a += '<div><div class="weui_cell" style="padding:5px 15px;"><div class="weui_cell_hd"><img src="' + o + '" style="border-radius:300px;width:30px;height:30px;vertical-align:top;"></div><div class="weui_cell_bd weui_cell_primary"><span style="margin:0 8px;display:inline-block;font-size:12px;color:#333;">' + n.author + '<br><span style="float:left;font-size:11px;color:#999;">' + n.dateline + '</span></span></div><div class="weui_cell_ft" style="font-size:11px;color:#aaa">楼主' + f + '</div></div><div style="padding:5px;word-break:break-all;" class="content-div"><div id="submessage" style="padding:0 15px;">' + n.message + "</div><br>" + r.join("") + d.join("<br>") + "</div></div>", jQuery("#vth-topdiv-" + l).html(a);
        var v = jQuery("#oripaper").html();
        "" != v && jQuery("#submessage").html(v), jQuery("[name=threaddel]").click(function () {
            var e = jQuery(this).data("fid");
            MWT.confirm({
                msg: "确定删除该主题吗？"
            }, function () {
    ...
    function o(e) {
        var i = dz_avatar(e.authorid),
            t = '<div class="mwt-border-bottom"><div class="weui_cell" style="padding:5px 15px;"><div class="weui_cell_hd"><img src="' + i + '" style="border-radius:300px;width:30px;height:30px;vertical-align:top;"></div><div class="weui_cell_bd weui_cell_primary"><span style="margin:0 8px;display:inline-block;font-size:12px;color:#333;">' + e.author + '<br><span style="float:left;font-size:11px;color:#999;">' + e.dateline + '</span></span></div><div class="weui_cell_ft" style="font-size:11px;color:#aaa">' + e.number + '楼</div></div><div style="padding:5px 15px 25px 15px;" class="content-div">' + e.message + "</div></div>";
        return t
    }
    ...
    function r(e, i) {
        ...
        1 == i && "" == u && (u = '<p align="center" style="color:#aaa;font-size:13px;margin-top:5px;">暂无回复</p>'), jQuery("#" + c).html(u), jQuery("#" + s + "-nbtn").unbind("click").click(function () {
            var e = jQuery(this).data("page");
            a(e)
        })
    }
    ...
    return p.open = function (i, a) {
        l = a, t(), e("common/backtop").init(50)
    }, p
}), define("common/exmsg", ["require"], function (e) {
    var i = {};
...
}), define("portal/channel_panel", ["require", "./index"], function (e) {
    var i, t = {};
    return t.init = function (t) {
        ...
        for (var a = [], n = 0; n < t.length; ++n) {
            ...
            a.push({
                ...
                handler: function (t) {
                    i.close(), e("./index").active_channel(t)
                }
            })
        }
        var r = 4,
...
}), define("portal/channel_body", ["require", "common/exmsg", "ajax", "common/location"], function (e) {
    function i(t, a, n, r, l) {
        n = parseInt(n), r = parseInt(r), l = parseInt(l);
        ...
        jQuery("#articlelist-" + t + "-" + n).html(p), jQuery("[name=articlebk-" + t + "]").unbind("click").click(function () {
            var i = jQuery(this).data("aid");
            e("common/location").viewarticle(i)
        }), m > n && jQuery("#artlist-nbtn-" + t).unbind("click").click(function () {
            var e = jQuery(this).data("page");
            MWT.show_loading(), o.post2("portal&action=articlelist&catid=" + t, {
                page: e
            }, function (e) {
                return MWT.hide_loading(), 0 != e.retcode ? void MWT.alert(e.retmsg) : void i(t, e.data.root, e.data.page, e.data.totalProperty, e.data.perpage)
            })
        })
    }
    ...
    function a(e) {
        ...
        MWT.show_loading(), o.post2("portal&action=articlelist&catid=" + e, {}, function (a) {
            return MWT.hide_loading(), 0 != a.retcode ? void i.html(n.error(a.retmsg)) : 0 == a.data.root.length ? void i.html('<p align="center" style="color:#999;padding-top:10px;">该频道下没有您可看的文章</p>') : void t(e, a.data.root, 3, a.data.totalProperty, a.data.perpage)
        })
    }
    ...
    return r.show_channel = function (e) {
        jQuery("[name=channelbodydiv]").hide(), jQuery("#channelbodydiv-" + e).show(), l[e] || (a(e), l[e] = !0)
    }, r
}), define("portal/index", ["require", "common/exmsg", "common/location", "./channel_panel", "ajax", "./channel_body", "common/header", "ad/global_full_ad", "common/backtop"], function (e) {
    function i(i) {
        var t = d[i];
    ...
    function t(e) {
        ...
        for (var t = [], a = 0, o = 0; o < e.length; ++o) {
            ...
            d.push({
                ...
                width: u,
                handler: i
            }), t.push('<div name="channelbodydiv" id="channelbodydiv-' + l.catid + '"></div>'), l.catid == s && (a = o)
        }
        jQuery("#portal-div").html(t.join("")), n = new MWT.ScrollBar({
            render: "channelbar-div",
            items: d
        }), n.create(), r.init(d), c.active_channel(a)
    }
    ...
    function a() {
        ...
        jQuery("body").append(i), jQuery("#channellistdownbtn").click(function () {
            r.open()
        });
        var a = e("common/header").createHeader({
            render: "headdiv",
        ...
        if (a.create(), bigstyle_conf.plugin_type < 2) {
            ...
            jQuery("#channelbar-div").hide(), jQuery("#downbtndiv").hide(), jQuery("#portal-div").html(n)
        } else l.post2("portal&action=channellist", {}, function (e) {
    ...
    return c.active_channel = function (e) {
        ...
        s = t, a(), e("ad/global_full_ad").init(), e("common/backtop").init(50)
    }, c
}), define("portal/comment", ["require", "ajax"], function (e) {
    function i(e, n, o, r) {
        n = parseInt(n), o = parseInt(o), r = parseInt(r);
        ...
        jQuery("#article-comment-" + n).html(p), m > n && jQuery("#comments-nbtn").unbind("click").click(function () {
            var e = jQuery(this).data("page");
            MWT.show_loading(), a.post2("portal&action=comments", {
                aid: t,
                page: e
            }, function (e) {
                MWT.hide_loading(), i(e.data.root, e.data.page, e.data.totalProperty, e.data.perpage)
            })
        })
    }
    var t, a = e("ajax"),
    ...
    return n.query = function (e, n) {
        t = e, a.post2("portal&action=comments", {
            aid: t,
            page: n
        }, function (e) {
...
}), define("portal/view", ["require", "common/exmsg", "ajax", "common/header", "./comment", "./comment", "common/backtop"], function (e) {
    function i(e) {
    ...
    function t(e) {
        for (var i = "", t = 0; t < e.length; ++t) i += e[t].content;
        jQuery("#article-content").html(i)
    }

    function a(e) {
        if (0 != e.length) {
            for (var i = '<div class="weui_cells_title"><span class="blocktitle" style="margin-left:5px;">相关阅读</span></div><div class="weui_cells">', t = 0; t < e.length; ++t) {
                var a = e[t],
            ...
            i += "</div>", jQuery("#article-related").html(i), jQuery("[name=relatedart]").unbind("click").click(function () {
    ...
    function n() {
        ...
        bigstyle_conf.plugin_version >= 1.8 && c.create(), MWT.show_loading(), d.post2("portal&action=viewarticle", {
            aid: r
        }, function (n) {
            MWT.hide_loading(), 0 != n.retcode ? jQuery("#viewarticle-div").html(l.error(n.retmsg)) : (i(n.data.article), t(n.data.contents), a(n.data.related_articles), e("./comment").query(r, 1))
        })
    }
    ...
    return s.open = function (i, t) {
        r = t, n(), e("common/backtop").init()
    }, s
}), define("data/notice", ["ajax"], function () {
    function e() {
    ...
    return t.getlist = function () {
        return 0 == a.length && e(), a
    }, t
}), define("home/space_pm", ["require", "ajax", "common/header", "common/copyright", "data/notice"], function (e) {
    function i() {
        a = new MWT.H5Page({
    ...
    function t() {
        ...
        for (var t = '<div class="weui_cells" style="margin-top:0;">', a = 0; a < i.length; ++a) {
            var n = i[a];
        ...
        t += "</div>", jQuery("#mynotelistdiv").html(t), jQuery("[name=topthread]").unbind("click").click(function () {
    ...
    return n.open = function (e) {
        a || i(), a.setAnimate(e).open()
    }, n
}), define("home/uc", ["require", "ajax", "common/copyright", "member/login"], function (e) {
    function i() {
        a = new MWT.H5Page({
    ...
    function t() {
        ...
        a += "</div>", jQuery("#ucdiv").html(a), jQuery("#ucbtn").click(function () {
            0 == dz.uid && e("member/login").login()
        })
    }
    var a, n = (e("ajax"), {});
...
}), define("home/space_profile", ["require", "common/header", "ajax", "common/header"], function (e) {
    function i() {
    ...
    function t() {
        ...
        o.post(e, {}, function (e) {
            var i = e.Variables.space,
                ...
                n = [
                    ["用户名", i.username],
                    ["用户组", i.group.grouptitle],
                    ["管理组", i.admingroup.grouptitle],
                    ["注册时间", i.regdate]
                ];
            t += a(n), n = [
                ["主题数", i.threads],
            ...
            t += a(n), jQuery("#uc-profile-body").html(t)
        })
    }

    function a(e) {
        for (var i = "<div class='weui_cells'>", t = 0; t < e.length; ++t) {
            var a = e[t];
...
}), define("home/space_thread", ["require", "common/location", "common/header", "ajax"], function (e) {
    function i() {
        o = new MWT.H5Page({
            render: "uc-mythread",
            header: l.createHeader({
            ...
            var e = "version=4&module=profile";
            d.post(e, {}, function (e) {
                s = e.Variables.space.threads, jQuery("#mythreadtitle").html("我的帖子(" + s + ")"), t(1)
            })
        })
    }
    ...
    function n(e, i) {
        ...
        jQuery("#" + c).html(u), jQuery("#" + d + "-nbtn").unbind("click").click(function () {
            var e = jQuery(this).data("page");
            t(e)
        }), jQuery("[name=topthread]").unbind("click").click(function () {
            var e = jQuery(this).data("tid");
    ...
    return c.open = function (e) {
        o || i(), o.setAnimate(e).open()
    }, c
}), define("home/space_favorite", ["require", "common/location", "common/header", "ajax"], function (e) {
    function i() {
    ...
    function o(e) {
        if (e.todayposts>0){
            var i = '<div name="fmdiv" data-fid="' + e.id + '" class="weui_cell"><div class="weui_cell_bd weui_cell_primary">' + e.title + '<br><span style="font-size:13px;">主题:' + e.threads + " | 帖子:" + e.posts + '</span></div><div class="weui_cell_ft"><span style="color:#ff0000;font-size:14px;padding:5px 10px;">( ' + e.todayposts + " )</span></div></div>";
        }else{
            var i = '<div name="fmdiv" data-fid="' + e.id + '" class="weui_cell"><div class="weui_cell_bd weui_cell_primary">' + e.title + '<br><span style="font-size:13px;">主题:' + e.threads + " | 帖子:" + e.posts + '</span></div></div>';
    ...
    function r(e, i) {
        ...
        jQuery("#" + u).html(p), jQuery("#" + c + "-nbtn").unbind("click").click(function () {
            var e = jQuery(this).data("page");
            a(e)
        }), jQuery("[name=topthread]").unbind("click").click(function () {
            var e = jQuery(this).data("tid");
    ...
    return p.open = function (e) {
        l || t(), l.setAnimate(e).open()
    }, p
}), define("setting/index", ["require", "member/login", "common/location", "common/header", "ajax", "common/copyright"], function (e) {
    function i() {
        t = new MWT.H5Page({
            render: "uc-setting",
    ...
    return o.open = function (e) {
        t || i(), t.setAnimate(e).open()
    }, o
}), define("setting/about", ["require", "common/location", "common/header", "ajax"], function (e) {
    function i() {
        a = new MWT.H5Page({
...
}), define("log", ["require", "conf"], function (e) {
    function i(e, i) {
        var t = "[" + e + "] " + i;
        console.log(t)
    }
...
define("jsapp", ["require", "conf", "index/page", "index/page2", "forum/forumlist", "forum/forumdisplay", "forum/newthread", "forum/viewthread", "portal/index", "portal/view", "home/space_pm", "home/uc", "home/space_profile", "home/space_thread", "home/space_favorite", "setting/index", "setting/about", "log"], function (e) {
    ...
    return t.run = function (t, a) {
        ...
        if (!in_array("mobile", dz.mobile_plugins)) {
            ...
            throw jQuery("body").html(o), new Error("请安装并启用掌上论坛插件(1.4.7版本及以上)")
        }
        log = e("log"), log.debug("dz: " + JSON.stringify(dz)), log.debug("bigstyle_conf: " + JSON.stringify(bigstyle_conf));
        ...
        log.uplog(r.join("||")), i[n].open(pageOpenAnimate, a)
    }, t
});